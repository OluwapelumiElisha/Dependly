...
const signUp = () => {
    ...
    return (
        ...
        //     <div className="min-h-screen bg-cover bg-center">
                <div className="lg:w-[50%] md:w-[70%] sm:w-[80%] w-[90%] m-auto p-4 bg-[#F7F8F8] flex justify-center items-center">
                    <div className="lg:w-[60%] md:w-[60%] sm:w-[90%] w-[90%] mb-14 ">
                        <h1 className={`font-bold text-[18px] text-primaryColor mt-0  mb-5 ${abeezee.className}`}>Create your Dependly account</h1>
                        <Form {...form}>
